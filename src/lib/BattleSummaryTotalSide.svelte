...
<ol style:background-color={color} style:flex-grow="1">
    ...
    {#each army.units as unit}
        <li>
            <ol style:flex-direction={flex_direction}>
                ...
                <li style:text-align={text_alignment}>
                    {unit.days[0].strength}
                </li>
                <li style:text-align={text_alignment}>
                    {unit.days[unit.days.length - 1].remaining}
                </li>
                <li style:text-align={text_alignment}>
                    {unit.days.reduce((acc, day) => acc + day.died, 0)}
                </li>
                <li style:text-align={text_alignment}>
                    {unit.days.reduce((acc, day) => acc + day.killed, 0)}
                </li>
            </ol>
        </li>
    {/each}
    ...
    <li>
        <ol style:flex-direction={flex_direction}>
            <li style:text-align={text_alignment}>Total</li>
            <li style:text-align={text_alignment}>
                {army.days[0].strength}
            </li>
            <li style:text-align={text_alignment}>
                {army.days[army.days.length - 1].remaining}
            </li>
            <li style:text-align={text_alignment}>
                {army.days.reduce((acc, day) => acc + day.died, 0)}
            </li>
            <li style:text-align={text_alignment}>
                {army.days.reduce((acc, day) => acc + day.killed, 0)}
            </li>
        </ol>
    </li>
</ol>
