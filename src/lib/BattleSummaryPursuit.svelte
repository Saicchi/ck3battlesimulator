<script lang="ts">
    import BattleSummaryPursuitSide from "./BattleSummaryPursuitSide.svelte";
...
<div class="battleday">
    <div class="battledayInfo">
        <div style="width: 10%;">3 days of pursuit</div>
        <div style="width: 10%;">Pursuit Phase</div>
        <div
